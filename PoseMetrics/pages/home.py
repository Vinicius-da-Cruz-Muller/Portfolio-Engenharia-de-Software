...
def exibir_home():
    ...
    with col1:
        ...
        st.write("É recomendado aos pacientes a presença em consultório com 15 minutos de antecedência.")
        st.write("Caso o paciente necessite remarcar, você pode alterar a data da consulta na aba Pacientes, em Editar Pacientes.")
